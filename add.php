...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO NHANVIEN (Ma_Nhan_Vien, Nguyen_Thi_Hai, Ha_Noi, Tai_Chinh, Luong, Hinh_Anh, Gioi_Tinh) 
            VALUES ('$ma_nv', '$ten_nv', '$dia_chi', '$phong_ban', $luong, '$hinh_anh', '$gioi_tinh')";
